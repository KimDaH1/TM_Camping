...
<%
	...
	//페이징 처리
	String listUrl = "CampListGangwon.jsp"+param;
...
<script type="text/javascript">
	function sendIt(){
		...
		f.action = "<%=cp %>/CampListGangwon.jsp"; 
		f.submit();
	}
	function clickTest(){
		var table =document.getElementById('testTable');
		  ...
		  for (i=1; i<rowList.length; i++) {//thead부분 제외.
		      ...
		      row.onclick = function(){ 
		         ...
		         var link = 'http://localhost:8080/ThreeMenCamping/DetailGangwon.jsp?data=' + str;
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="row">
                    <div class="col"><img src="./image/강원1.jpg" class="d-block w-100" alt="image1" style="width:250px;height:200px;"></div>
                    <div class="col"><img src="./image/강원2.jpg" class="d-block w-100" alt="image2" style="width:250px;height:200px;"></div>
                    <div class="col"><img src="./image/강원3.jpg" class="d-block w-100" alt="image3" style="width:250px;height:200px;"></div>
                </div>
            </div>
            <div class="carousel-item">
                <div class="row">
                    <div class="col"><img src="./image/강원4.jpg" class="d-block w-100" alt="image4" style="width:250px;height:200px;"></div>
                    <div class="col"><img src="./image/강원5.jpg" class="d-block w-100" alt="image5" style="width:250px;height:200px;"></div>
                    <div class="col"><img src="./image/강원6.jpg" class="d-block w-100" alt="image6" style="width:250px;height:200px;"></div>
                </div>
            </div>
            <div class="carousel-item">
                <div class="row">
                    <div class="col"><img src="./image/강원7.jpg" class="d-block w-100" alt="image7" style="width:250px;height:200px;"></div>
                    <div class="col"><img src="./image/강원8.jpg" class="d-block w-100" alt="image8" style="width:250px;height:200px;"></div>
                    <div class="col"><img src="./image/강원9.jpg" class="d-block w-100" alt="image9" style="width:250px;height:200px;"></div>
                </div>
            </div>
        </div>
    </div>
