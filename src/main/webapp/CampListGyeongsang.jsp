...
<body style="background-image: url(./image/경상도배경.jpg);">
<style>
body{
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="row">
                    <div class="col"><img src="./image/경상1.jpg" class="d-block w-100" alt="image1" style="width:250px;height:200px;"></div>
                    <div class="col"><img src="./image/경상2.jpg" class="d-block w-100" alt="image2" style="width:250px;height:200px;"></div>
                    <div class="col"><img src="./image/경상3.jpg" class="d-block w-100" alt="image3" style="width:250px;height:200px;"></div>
                </div>
            </div>
            <div class="carousel-item">
                <div class="row">
                    <div class="col"><img src="./image/경상4.jpg" class="d-block w-100" alt="image4" style="width:250px;height:200px;"></div>
                    <div class="col"><img src="./image/경상5.jpg" class="d-block w-100" alt="image5" style="width:250px;height:200px;"></div>
                    <div class="col"><img src="./image/경상6.jpg" class="d-block w-100" alt="image6" style="width:250px;height:200px;"></div>
                </div>
            </div>
            <div class="carousel-item">
                <div class="row">
                    <div class="col"><img src="./image/경상7.jpg" class="d-block w-100" alt="image7" style="width:250px;height:200px;"></div>
                    <div class="col"><img src="./image/경상8.jpg" class="d-block w-100" alt="image8" style="width:250px;height:200px;"></div>
                    <div class="col"><img src="./image/경상9.jpg" class="d-block w-100" alt="image9" style="width:250px;height:200px;"></div>
                </div>
            </div>
        </div>
    </div>
